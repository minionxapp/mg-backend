...
const get = async (req, res, next) => {
    try {
        ...
        let model = "<br><br>//=================================Begin Prisma Client==========================<br>" +
            'model ' + namaModel + "{<br>"
        ...
        let validate = "<br><br>//==============================================Begin Validation====================<br>" +
            "<br><br>import Joi from \"joi\";<br><br>"
        ...
        test = test + "//===Begin Test Create===<br><br>" +
        ...
        test = test + "//===Begin Test Get===<br><br>" +
